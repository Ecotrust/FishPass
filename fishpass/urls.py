...
urlpatterns = [
    ...
    url(r'^get_report_geojson_by_budget/(?P<report_uid>[\w_]+)/(?P<budget>[\w_]+)/$', views.get_report_geojson_by_budget),
    url(r'^get_barrier_report/(?P<report_uid>[\w_]+)/(?P<barrier_id>[\w_]+)/(?P<budget>[\w_]+)/$', views.get_barrier_report),
